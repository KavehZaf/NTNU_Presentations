...
\textbf{Optimal Power Flow (OPF)} solvers are essential
\end{alertblock}}
...
\end{enumerate}
\item Optimal utilization of stored energy and flexibility where and when it creates the highest value for the system
